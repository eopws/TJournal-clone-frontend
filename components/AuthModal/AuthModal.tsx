            ...
            <DialogContent className={scss.modalContentWrapper}>
                <div className={scss.modalCover}>
                    <div className={scss.modalCover__siteLogo}>
                        <svg viewBox="0 0 24 25" id="site_logo"><path fill="#e8a427" d="M0 19h8.5v6H0v-6z"></path><path d="M0 7h8.5v18l6.5-6V7h9V0H0v7z"></path><path fill="rgba(0,0,0,0.15)" d="M7.5 19h1v6l-1-6z"></path></svg>
                    </div>
                </div>
                <div className={scss.modalContent}>
                    ...
                    {authType !== null &&
                        ...
                        >
                            <svg viewBox="0 0 24 24" id="v_chevron_left"><path fillRule="evenodd" clipRule="evenodd" d="M14.207 6.293a1 1 0 010 1.414L9.914 12l4.293 4.293a1 1 0 01-1.414 1.414l-5-5a1 1 0 010-1.414l5-5a1 1 0 011.414 0z"></path></svg>
                            К авторизации
                        </span>
                    }
